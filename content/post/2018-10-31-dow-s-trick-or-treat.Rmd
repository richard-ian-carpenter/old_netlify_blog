...
The Dow Jones Industrial Average (DJIA) showed gave us an interesting, if not a little scary, performance this month.  When we look at the difference in closing prices, we can see that it was mostly within a range of +/-500 points:
...
Something to build on from here would be looking at the components of the DJIA and compare their individual performances over the same time period.  I am working on creating a Shiny app since it is more dynamic than this blog.  Once that is complete, I will include a link to it.
