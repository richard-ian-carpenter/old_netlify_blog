...
p1 <- ggplot(data = df, aes(x = ordered(as.factor(date)), y = close, group = 1)) +
    geom_line() +
    theme_bw() + 
...
p2 <- ggplot(data = df, aes(x = ordered(as.factor(date)), y = daily_diff, group = 1)) + 
	geom_line() +
    theme_bw() +
    ...
    labs(title = "Dow Jones Index, October 2018",
         ...
         caption = "Source: Yahoo! Finance")
p3 <- ggplot(data = df, aes(x = ordered(as.factor(date)), y = pct_change, group = 1)) + 
	geom_line() +
    theme_bw() +
    ...
    labs(title = "Dow Jones Index, October 2018",
         ...
         x = "Date", y = "Percent", 
         caption = "Source: Yahoo! Finance")
p4 <- ggplot(data = df, aes(x = ordered(as.factor(date)), y = level_change, group = 1)) + 
	geom_line() +
    theme_bw() +
    geom_hline(aes(yintercept = 0), color = "blue") +
    labs(title = "Dow Jones Index, October 2018",
...
# Simple plots and another summary statistic:
p6 <- ggplot(data = df2, aes(x = ordered(as.factor(date)), y = close, group = 1)) + 
	geom_line() +
    theme_bw() +
    ...
    labs(title = "Dow Jones Index, 2 Jan 2018 to 31 Oct 2018",
         ...
         x = "Date", y = "Closing Price", 
         caption = "Source: Yahoo! Finance")
p7 <- ggplot(data = df2, aes(x = ordered(as.factor(date)), y = daily_diff, group = 1)) + 
	geom_line() +
    theme_bw() +
    geom_hline(aes(yintercept = 0), color = "blue") +
    labs(title = "Dow Jones Index, 2 Jan 2018 to 31 Oct 2018",
         ...
         x = "Date", y = "Difference in Closing Price", 
         caption = "Source: Yahoo! Finance")
p8 <- ggplot(data = df2, aes(x = ordered(as.factor(date)), y = pct_change, group = 1)) + 
	geom_line() +
    theme_bw() +
    geom_hline(aes(yintercept = 1.0), color = "blue") +
    labs(title = "Dow Jones Index, 2 Jan 2018 to 31 Oct 2018",
         ...
         x = "Date", y = "Percent", 
         caption = "Source: Yahoo! Finance")
p9 <- ggplot(data = df2, aes(x = ordered(as.factor(date)), y = level_change, group = 1)) + 
	geom_line() +
    theme_bw() +
    geom_hline(aes(yintercept = 0), color = "blue") +
    labs(title = "Dow Jones Index, 2 Jan 2018 to 31 Oct 2018",
