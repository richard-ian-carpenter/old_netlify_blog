...
In my [first post](https://www.justadatageek.com/2018/07/21/exploring-burlington-county-nj/), I mentioned the autocorrlation of the data.  I will post the autocorrelation graph here again, using the `acf` function in `R`:
...
I am going to leave off here.  I plan on decomposing the data further, to see separate out the seasonal component.  There are a few other ways I can explore the data, such as comparing my Burlington County to the surrounding counties, the State of New Jersey, and the national employment figures.  I can also breakdown private employment into major NAICS codes to see which industries drive employment in the county.  (Hat tip again to Tom, who I brainstormed ideas with via email.)
